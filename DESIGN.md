...
- **The nav pays for its 44px entirely in reach.** It is already a tenth of the screen once it wraps, so no control here grows: the search and theme icons sit a gap apart rather than shoulder to shoulder, and the mode pills wear `.tap-reach--low`, hanging their reach into the pane's foot instead of contesting the row above.

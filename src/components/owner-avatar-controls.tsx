...
const ghostButton =
  'tap-reach inline-flex items-center justify-center gap-1.5 rounded border border-hairline-soft px-3 py-1.5 text-sm font-semibold text-fg-muted transition-colors duration-200 hover:text-fg disabled:cursor-not-allowed disabled:opacity-50'
  ...
  return (
    <div className="mt-4 flex flex-wrap items-center gap-x-3 gap-y-2">
      ...
      {hasAvatar && (
        <button
          type="button"
          className="tap-reach text-sm font-semibold text-fg-muted underline decoration-hairline underline-offset-2 hover:text-fg disabled:cursor-not-allowed disabled:opacity-50"
          disabled={busy}

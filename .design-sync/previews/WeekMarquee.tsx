...
const driftingWeek = [
  ...records,
  // prettier-ignore
  { id: 4, kills: 21, vehicleSlug: 'strv-122b-plss', vehicleName: 'Strv 122B PLSS', isRemoved: false, nationName: 'Sweden', playerSlug: 'norrlandwolf', displayName: 'NorrlandWolf', ignSnapshot: null, displayNameSnapshot: null, verifiedAt: new Date('2026-06-29T12:00:00Z') },
  // prettier-ignore
  { id: 5, kills: 19, vehicleSlug: 'leopard-2a7v', vehicleName: 'Leopard 2A7V', isRemoved: false, nationName: 'Germany', playerSlug: 'panzerlehr', displayName: 'PanzerLehr', ignSnapshot: null, displayNameSnapshot: null, verifiedAt: new Date('2026-06-28T12:00:00Z') },
  // prettier-ignore
  { id: 6, kills: 18, vehicleSlug: 'm1a2-sep-v2', vehicleName: 'M1A2 SEP v2', isRemoved: false, nationName: 'USA', playerSlug: 'abramsprime', displayName: 'AbramsPrime', ignSnapshot: null, displayNameSnapshot: null, verifiedAt: new Date('2026-06-27T12:00:00Z') },
  // prettier-ignore
  { id: 7, kills: 17, vehicleSlug: 'amx-40', vehicleName: 'AMX-40', isRemoved: false, nationName: 'France', playerSlug: 'gallicrooster', displayName: 'GallicRooster', ignSnapshot: null, displayNameSnapshot: null, verifiedAt: new Date('2026-06-26T12:00:00Z') },
]
